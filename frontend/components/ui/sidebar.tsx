...
>(
  (
    ...
    // easier to style sidebar w/ tailwind classes if we can attach data-state="expanded" or "collapsed"
      ...
      >
        ...
        <div
          className={cn(
            ...
            // adjusts padding for floating and inset variants
            variant === "floating" || variant === "inset"
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        // increases button hit area on mobile devices
